  ...
  return (
    <div>
      <div className='relative'>
        <p className='text-2xl font-bold absolute bottom-0 left-0 text-white z-10 p-10 w-[500px] xl:max-[1515px]:w-[300px] min-[768px]:max-[1280px]:w-[250px] xl:max-[1515px]:text-base xl:max-[1515px]:p-5 min-[768px]:max-[1280px]:text-sm min-[768px]:max-[1280px]:p-5 max-md:text-xs max-md:p-3 max-md:w-[300px]'>{description}</p>
