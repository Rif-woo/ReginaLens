...
const QualityBox = ({ title, description, logo }) => {
  return (
    <div className='flex flex-col justify-center items-center gap-4 border border-[#1E1E1E] p-8 xl:max-[1515px]:p-6 min-[768px]:max-[1280px]:p-4 rounded-lg w-[600px] xl:max-[1515px]:w-[450px] min-[768px]:max-[1280px]:w-[350px] max-md:w-[300px] max-md:p-3 max-md:gap-2'>
