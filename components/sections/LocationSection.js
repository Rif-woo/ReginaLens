...
const LocationSection = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-4 w-full mb-32 '>
      <h1 className='text-4xl font-medium mb-8 uppercase xl:max-[1515px]:text-2xl min-[768px]:max-[1280px]:text-2xl max-md:text-2xl text-center '>Nous retrouver ici </h1>
