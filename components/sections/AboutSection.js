...
const AboutSection = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-4 w-full mb-48 max-md:mb-28' id='AboutUs'>
      ...
      <div className='flex justify-center items-center gap-16 w-full max-md:flex-col'>
        ...
        <div className='md:hidden'>
          <Image
            ...
            width={600}
            height={300}
            className="object-cover object-top h-[350px] w-[350px] rounded-lg max-md:mb-8"
          />
        </div>
          <QualityBox
            title="Notre Vision"
