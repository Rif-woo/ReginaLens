...
const WhyChooseUsSection = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-4 w-full mb-48'>
      <h1 className='text-4xl font-medium mb-8 uppercase xl:max-[1515px]:text-2xl xl:max-[1515px]:mb-5 min-[768px]:max-[1280px]:text-2xl min-[768px]:max-[1280px]:mb-3 max-md:text-xl max-md:w-[350px] max-md:text-center  max-md:font-semibold'>Pourquoi choisir Regina Lens ?</h1>
